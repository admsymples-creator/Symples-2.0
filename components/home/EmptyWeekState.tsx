...
interface EmptyWeekStateProps {
  onAction?: () => void;
  skeletonOnly?: boolean; // ✅ Novo prop para mostrar apenas o esqueleto
}

export function EmptyWeekState({ onAction, skeletonOnly = false }: EmptyWeekStateProps) {
  return (
    <div className="w-full min-h-[500px] relative border-2 border-dashed border-slate-200 rounded-xl bg-slate-50/50 overflow-hidden">
      ...
      {/* Central Content - Floating - HIDE if skeletonOnly is true */}
      {!skeletonOnly && (
