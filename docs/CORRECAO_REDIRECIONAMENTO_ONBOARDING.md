...
- **NOVO (2025-01-07):** Corrigido problema de timing no login tradicional
  - Implementada lógica de retry com `getUserWorkspaces()` para login tradicional
  - Aguarda 300ms inicial + até 3 tentativas com 500ms entre cada uma
  - Resolve problema onde usuários admin eram redirecionados para onboarding na primeira vez
  - Após refresh funcionava, mas agora funciona na primeira tentativa
